...
<nav class="navbar navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
   	<img alt="" src="https://t4.ftcdn.net/jpg/02/17/36/83/360_F_217368346_U0trhJeBSG7M9feVwW073Eb3m9j5CIcW.jpg" width="80" height="50" class="d-inline-block align-text-top">
    </a>
...
<c:forEach items="${errors}" var="e">
	...
	BrandName : <input type="text" required="required" name ="name" value="${dto.brandName}"/>
