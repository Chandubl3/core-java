...
<div class="typing">
        <h2 class="text-uppercase">Searching By BrandName.....</h2>
    </div>
    
<form action="searchbybrandname">
		...
		<table class="table table-dark table-striped">
			...
			<c:forEach items="${list}" var="l">
				<tr class="table-primary">
					...
					<td class="table-primary"><a href="update?id=${l.id}">Edit</a></td>
					<td class="table-primary"><a href="delete?id=${l.id}">Remove</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
